...
use midnightPublishing\mutantWar\database\User as ChildUser;
...
abstract class UserQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \midnightPublishing\mutantWar\database\Base\UserQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'mutant_war', $modelName = '\\midnightPublishing\\mutantWar\\database\\User', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT `USER_NAME`, `PASSWORD`, `FIRST_NAME`, `LAST_NAME` FROM `users` WHERE `USER_NAME` = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(UserTableMap::COL_USER_NAME, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(UserTableMap::COL_USER_NAME, $keys, Criteria::IN);
    }
    ...
    {
        if ($user) {
            $this->addUsingAlias(UserTableMap::COL_USER_NAME, $user->getuserName(), Criteria::NOT_EQUAL);
        }
