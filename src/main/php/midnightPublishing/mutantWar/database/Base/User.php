...
namespace midnightPublishing\mutantWar\database\Base;
...
use midnightPublishing\mutantWar\database\UserQuery as ChildUserQuery;
use midnightPublishing\mutantWar\database\Map\UserTableMap;
 ...
 *
 *
* @package    propel.generator.midnightPublishing.mutantWar.database.Base
*/
abstract class User implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\midnightPublishing\\mutantWar\\database\\Map\\UserTableMap';
    ...
    /**
     * Initializes internal state of midnightPublishing\mutantWar\database\Base\User object.
     */
     ...
     * @return $this|\midnightPublishing\mutantWar\database\User The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\midnightPublishing\\mutantWar\\database\\User'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\midnightPublishing\mutantWar\database\User
     */
     ...
     *
     * @return $this|\midnightPublishing\mutantWar\database\User The current object, for fluid interface
     */
    ...
    /**
     * Generic method to set the primary key (user_name column).
     *
     ...
     * objects.
     *
     * @param      object $copyObj An object of \midnightPublishing\mutantWar\database\User (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \midnightPublishing\mutantWar\database\User Clone of current object.
     * @throws PropelException
     */
