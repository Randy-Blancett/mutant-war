...
namespace midnightPublishing\mutantWar\database\Map;
...
class UserTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'midnightPublishing.mutantWar.database.Map.UserTableMap';

    /**
     * The default database name for this class
     */
    const DATABASE_NAME = 'mutant_war';
     ...
     */
    const OM_CLASS = '\\midnightPublishing\\mutantWar\\database\\User';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'midnightPublishing.mutantWar.database.User';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(UserTableMap::COL_USER_NAME, UserTableMap::COL_PASSWORD, UserTableMap::COL_FIRST_NAME, UserTableMap::COL_LAST_NAME, ),
        self::TYPE_RAW_COLNAME   => array('COL_USER_NAME', 'COL_PASSWORD', 'COL_FIRST_NAME', 'COL_LAST_NAME', ),
        self::TYPE_FIELDNAME     => array('user_name', 'password', 'first_name', 'last_name', ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(UserTableMap::COL_USER_NAME => 0, UserTableMap::COL_PASSWORD => 1, UserTableMap::COL_FIRST_NAME => 2, UserTableMap::COL_LAST_NAME => 3, ),
        self::TYPE_RAW_COLNAME   => array('COL_USER_NAME' => 0, 'COL_PASSWORD' => 1, 'COL_FIRST_NAME' => 2, 'COL_LAST_NAME' => 3, ),
        self::TYPE_FIELDNAME     => array('user_name' => 0, 'password' => 1, 'first_name' => 2, 'last_name' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\midnightPublishing\\mutantWar\\database\\User');
        $this->setPackage('midnightPublishing.mutantWar.database');
        $this->setUseIdGenerator(false);
        // columns
        $this->addPrimaryKey('USER_NAME', 'userName', 'VARCHAR', true, 20, null);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \midnightPublishing\mutantWar\database\User) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(UserTableMap::DATABASE_NAME);
            $criteria->add(UserTableMap::COL_USER_NAME, (array) $values, Criteria::IN);
        }
